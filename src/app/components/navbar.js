...
export default function Navbar() {
  //creating state for when a button/link is open
  const [isOpen, setIsOpen] = useState(false)

  return (
    <nav className="relative z-50 bg-sky-950 bg-opacity-75">
      <div className="max-w-screen-xl mx-auto px-4">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer" className="text-white hover:text-blue-500 transition-colors duration-200">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
